        ...
        <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            <a href="{{ route('homepage') }}" class="text-decoration-none">
                <h1 class="mb-4 display-5 font-weight-semi-bold"><span
                        class="text-primary font-weight-bold border border-white px-3 mr-1">E</span>Books</h1>
            </a>
            <p>Dolore erat dolor sit lorem vero amet. Sed sit lorem magna, ipsum no sit erat lorem et magna
                ipsum dolore amet erat.</p>
            <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Gaindakot, Nawalparasi,
                Nepal</p>
            ...
            <div class="row">
                <div class="col-md-4 mb-5">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        <a class="text-dark mb-2" href="/aboutUs"><i class="fa fa-angle-right mr-2"></i>About
                            Us</a>
                        <a class="text-dark mb-2" href="/refundPolicy"><i class="fa fa-angle-right mr-2"></i>Return and
                            Refund Policy</a>
                        <a class="text-dark mb-2" href="/termCondition"><i class="fa fa-angle-right mr-2"></i>Terms and
                            Condition</a>
                        <a class="text-dark mb-2" href="/privacyPolicy"><i class="fa fa-angle-right mr-2"></i>Privacy
                            Policy</a>
                    </div>
                </div>
                <div class="col-md-4 mb-5">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        <a class="text-dark mb-2" href="{{ route('homepage') }}"><i
                                class="fa fa-angle-right mr-2"></i>Home</a>
                        <a class="text-dark mb-2" href="/shopDetail"><i class="fa fa-angle-right mr-2"></i>Shop
                            Detail</a>
                        <a class="text-dark mb-2" href="/shoppingCart"><i class="fa fa-angle-right mr-2"></i>Shopping
                            Cart</a>
    ...
    <div class="row border-top border-light mx-xl-5 py-4">
        <div class="col-md-6 px-xl-0">
            <p class="mb-md-0 text-center text-md-left text-dark">Copyright
                &copy; 2024. <a class="text-dark font-weight-semi-bold" href="#">eBookStore.com</a> All
                Rights Reserved.
            </p>
        </div>
