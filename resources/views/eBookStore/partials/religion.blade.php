<div class="container-fluid pt-5" id="Religion-Spirituality">
    <div class="text-center mb-4">
        <h2 class="section-title px-5"><span class="px-2">Available Books</span></h2>
    </div>
    <div class="row px-3 pb-3">
        @foreach ($books->skip(10) as $book)
                ...
                <div class="card product-item border-0 mb-4" style="max-width: 200px;">
                    ...
                    <div class="card-body border-left border-right text-center p-0 pt-3 pb-1">
                        ...
                        <div class="d-flex justify-content-center">
                            <h6>Rs.{{ $book->price }}</h6>
                            <h6 class="text-muted ml-2"><del>Rs.123.00</del></h6>
                        </div>
                    </div>
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="#" data-title="{{ $book->title }}" data-price="{{ $book->price }}"
                            data-description="{{ $book->description }}" data-rating="{{ $book->rating }}"
                            data-image="{{ asset($book->image) }}" class="viewDetailBtn btn btn-sm text-dark p-0"><i
